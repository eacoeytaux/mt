...
void Sky::draw(const Camera * _camera) const {
    _camera->draw_rectangle({ m_top_color, m_bottom_color, m_bottom_color, m_top_color }, Rectangle(_camera->width() + 2, _camera->height() + 1, Coordinate(0, 0)), 0, 0); // added + 1 just in case
